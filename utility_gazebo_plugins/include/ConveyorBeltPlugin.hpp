...
#include "utility_ros2_interface/msg/conveyor_belt_state.hpp"
#include "utility_ros2_interface/srv/conveyor_belt_control.hpp"
...
namespace gazebo
{
  ...
  class GAZEBO_VISIBLE ConveyorBeltPlugin : public ModelPlugin
  {
    ...
    rclcpp::Service<utility_ros2_interface::srv::ConveyorBeltControl>::SharedPtr controlService_;

    /// \brief Publishes the state of the conveyor.
    //public: ros::Publisher statePub;
    /// Publisher for gripper action status
    rclcpp::Publisher<utility_ros2_interface::msg::ConveyorBeltState>::SharedPtr pub_;
